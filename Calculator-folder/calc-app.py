...
class Calculator:
    def __init__(self, master):
        ...
        master.geometry("312x324") # Setting window size
        master.resizable(0, 0) # This code prevents window resizing
        master.title("Calculator")

        # Entry Frame - just a container for grouping widgets
        ...
        self.e.pack(ipady=2) # 'ipady' is internal padding to increase the height of input field
